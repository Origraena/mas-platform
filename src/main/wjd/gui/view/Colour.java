...
public class Colour 
{
  ...
  // constructors
  /** Create a Colour from a set of real values (between 0.0f and 1.0f), where
   * 0 is empty (black) and 1 is full (white) for each channel, setting the
   * alpha channel to a default value of 1.0f (totally opaque).  
  ...
  /** Create a Colour from a set of real values (between 0.0f and 1.0f), where
   * 0 is empty (black) and 1 is full (white) for each channel.
   * @param r red channel, between 0.0f and 1.0f.
   * @param g green channel, between 0.0f and 1.0f.
   * @param b blue channel, between 0.0f and 1.0f.
